...
export class Logger {
  ...
  constructor(opts: TLogger.ConstructorOptions) {
    ...
    this.formatString = opts.format || Logger.defaultFormatString
  ...
  public formatMessage(msg: TLogger.Message, dformat = this.formatString, localPredefinedValues: TLogger.PredefinedValuesObject = {}, convertOptions: TLogger.ConvertOptions = {}) {
  ...
  // core logic
  public logWithOptions(raw: unknown[], options: Partial<TLogger.Message> = {}, convertOptions: TLogger.ConvertOptions = {}) {
